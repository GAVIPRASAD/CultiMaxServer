...
const { isAuthenticatedUser,authorizeRoles,authorizeCaptain } = require("../middleware/auth");
...
.put(isAuthenticatedUser,authorizeCaptain("captain"),authorizeRoles("admin"), updateUserRole)
.delete(isAuthenticatedUser,authorizeCaptain("captain"), authorizeRoles("admin"),deleteUser);
